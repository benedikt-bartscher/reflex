...
class StateProxy(wrapt.ObjectProxy):
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        value = super().__getattr__(name)  # type: ignore[reportAttributeAccessIssue]
...
class MutableProxy(wrapt.ObjectProxy):
    ...
    def __new__(cls, wrapped: Any, *args, **kwargs) -> MutableProxy:
        ...
        if dataclasses.is_dataclass(wrapped):
            ...
            if wrapper_cls_name not in cls.__dataclass_proxies__:
                ...
                cls.__dataclass_proxies__[wrapper_cls_name] = type(
                    ...
                    (cls,),
                    {
                        dataclasses._FIELDS: getattr(  # type: ignore [reportAttributeAccessIssue]
                            wrapped_cls,
        ...
        return super().__new__(cls)  # type: ignore[reportArgumentType]
    ...
    def __getattr__(self, __name: str) -> Any:
        ...
        Returns:
            The attribute value.
        """
        value = super().__getattr__(__name)  # type: ignore[reportAttributeAccessIssue]
        ...
        if callable(value):
            ...
            if __name in self.__wrap_mutable_attrs__:
                ...
                value = wrapt.FunctionWrapper(
                    value,
                    self._wrap_recursive_decorator,  # type: ignore[reportArgumentType]
                )
    ...
    def __getitem__(self, key: Any) -> Any:
        ...
        Returns:
            The item value.
        """
        value = super().__getitem__(key)  # type: ignore[reportAttributeAccessIssue]
    ...
    def __iter__(self) -> Any:
        ...
        """
        for value in super().__iter__():  # type: ignore[reportAttributeAccessIssue]
            # Recursively wrap mutable items retrieved through this proxy.
    ...
    def __delitem__(self, key: str):
        ...
        Args:
            key: The key of the item.
        """
        self._mark_dirty(super().__delitem__, args=(key,))  # type: ignore[reportAttributeAccessIssue]
    ...
    def __setitem__(self, key: str, value: Any):
        ...
        """
        self._mark_dirty(super().__setitem__, args=(key, value))  # type: ignore[reportAttributeAccessIssue]
...
json.JSONEncoder.default = _json_encoder_default_wrapper  # type: ignore[invalid-assignment]  # json.JSONEncoder.default monkey-patch
...
class ImmutableMutableProxy(MutableProxy):
    ...
    def _mark_dirty(
        ...
        """
        if not self._self_state._is_mutable():  # type: ignore[reportAttributeAccessIssue]
            msg = (
                "Background task StateProxy is immutable outside of a context "
                "manager. Use `async with self` to modify state."
            )
