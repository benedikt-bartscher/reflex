...
class DependencyTracker:
    ...
    def __post_init__(self):
        ...
        with contextlib.suppress(AttributeError):
            ...
            self.func = cast(FunctionType, self.func.func)  # type: ignore[reportAttributeAccessIssue]
        with contextlib.suppress(AttributeError):
            # unbox EventHandler
            self.func = cast(FunctionType, self.func.fn)  # type: ignore[reportAttributeAccessIssue,reportFunctionMemberAccess]
    ...
    def _get_globals(self) -> dict[str, Any]:
        ...
        if isinstance(self.func, CodeType):
            return {}
        return self.func.__globals__  # type: ignore[reportAttributeAccessIssue]
    ...
    def _get_closure(self) -> dict[str, Any]:
        ...
        return {
            ...
            for var_name, cell in zip(
                self.func.__code__.co_freevars,  # type: ignore[reportAttributeAccessIssue]
