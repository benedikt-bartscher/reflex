...
class ShikiCodeBlock(Component, MarkdownComponentMap):
    ...
    def create(
        ...
        **props,
        ...
        for transformer in code_block.transformers._var_value:  # type: ignore [reportAttributeAccessIssue]
    ...
    def create_transformer(cls, library: str, fns: list[str]) -> ShikiBaseTransformers:
        ...
        return ShikiBaseTransformers(
            library=library,
            fns=[FunctionStringVar.create(fn) for fn in fns],  # type: ignore [reportCallIssue]
        )
