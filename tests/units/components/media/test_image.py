...
def pil_image() -> Img:
    ...
    return PIL.Image.fromarray(imarray.astype("uint8")).convert("RGBA")  # type: ignore [reportAttributeAccessIssue]
...
def test_set_src_str():
    ...
    assert str(image.src) == '"pic2.jpeg"'  # type: ignore [reportAttributeAccessIssue]
