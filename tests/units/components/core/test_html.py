...
def test_html_create():
    ...
    assert str(html.dangerouslySetInnerHTML) == '({ ["__html"] : "<p>Hello !</p>" })'  # type: ignore [reportAttributeAccessIssue]
    assert (
        str(html)
...
def test_html_fstring_create():
    ...
    html_dangerouslySetInnerHTML = html.dangerouslySetInnerHTML  # type: ignore [reportAttributeAccessIssue]
