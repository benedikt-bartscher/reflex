...
async def test_client_side_state(
    ...
    async def poll_for_c1_set():
        ...
        return sub_state.c1 == "c1 post expire"  # type: ignore[reportAttributeAccessIssue]

    assert await AppHarness._poll_for_async(poll_for_c1_set)
    sub_state = await get_sub_state()
    assert sub_state.c1 == "c1 post expire"  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.c2 == "c2 value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.c3 == ""  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.c4 == "c4 value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.c5 == "c5 value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.c6 == "c6 value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.c7 == "c7 value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.l1 == "l1 value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.l2 == "l2 value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.l3 == "l3 value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.l4 == "l4 value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.s1 == "s1 value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.s2 == "s2 value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_state.s3 == "s3 value"  # type: ignore[reportAttributeAccessIssue]
    sub_sub_state = sub_state.substates[
        client_side.get_state_name("_client_side_sub_sub_state")
    ]
    assert sub_sub_state.c1s == "c1s value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_sub_state.l1s == "l1s value"  # type: ignore[reportAttributeAccessIssue]
    assert sub_sub_state.s1s == "s1s value"  # type: ignore[reportAttributeAccessIssue]
